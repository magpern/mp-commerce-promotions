...
**Cart/Checkout Blocks (2026-05-18):** Browser fee + coupon COD Pass (orders **4362**, **4363**); CLI cert 8/8 (promos 238–244). `cart_checkout_blocks` **declared**; status **passed**. [BLOCKS_QA_EVIDENCE_2026-05-18.md](BLOCKS_QA_EVIDENCE_2026-05-18.md)
