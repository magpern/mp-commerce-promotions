...
- **`Redemption`** / **`RedemptionRepository`** — append-only **`{prefix}mp_cp_redemptions`** rows (`insert`, `find_for_order`, `find_for_promotion`, **`exists_for_order_and_promotion`**, **`count_for_order`**); **no delete API**.
