...
- **Promotion templates** — seven admin presets on the edit screen (`PromotionTemplate` service) that overwrite conditions/actions/restrictions JSON using existing rule types only; see [docs/manual-promotion-templates-test.md](docs/manual-promotion-templates-test.md).
