...
- **All Promotions list** — row checkboxes and bulk **Activate**, **Pause**, and **Archive** (POST + nonce; respects allowed status transitions; no delete). Hard delete is not offered in admin.
